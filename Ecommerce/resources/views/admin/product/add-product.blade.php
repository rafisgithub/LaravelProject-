                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="{{route('new-product')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="inputFirstName" name="brand_name" type="text" placeholder="Brand Name" />
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="ProductName" name="product_price" type="text" placeholder="Product Price" />
                                            <label for="ProductName">Product Price</label>
                                        </div>
                                        <div class="form-floating mb-3">

                                            <textarea name="description" id="Description" cols="90" rows="7"></textarea>
