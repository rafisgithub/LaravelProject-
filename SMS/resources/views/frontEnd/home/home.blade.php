        ...
        <div class="container-fluid">
            <div class="row">
                <div class="pogoSlider" id="js-main-slider">
                    <div class="pogoSlider-slide" style="background-image:url({{asset('frontEndAsset')}}/images/banner1.png)">
                        <div class="container">

                        </div>
                    </div>
                    <div class="pogoSlider-slide" style="background-image:url({{asset('frontEndAsset')}}/images/banner2.png);">
