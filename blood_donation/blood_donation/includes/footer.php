<!--footer code started-->
<footer class="bg-dark dark:bg-dark-900">
  <section>
  <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
      <div>
          <h2 class="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Save Life</h2>
      ...
      <div>
          <h2 class="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">About us</h2>
          <ul class="text-gray-500 dark:text-gray-400">
              <li class="mb-4">
      ...
      <div>
          <h2 class="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Download App</h2>
          <ul class="text-gray-500 dark:text-gray-400">
              <li class="mb-4">
  ...
  <div class="py-6 px-4 bg-dark-100 dark:bg-dark-700 md:flex md:items-center md:justify-between">
      <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="#">Save Life™</a>. All Rights Reserved.
      </span>
